...
export const Input = () => {
   ...
   return (
      <div className={classes.inputWrapper}>
         <input className={state.wrongName ? classes.wrong_item :classes.input_item} value={state.firtsName} onChange={(e) => changeFirstName(e.target.value)} type="text" placeholder=' First Name'  />
